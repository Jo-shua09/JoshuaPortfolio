    ...
    <section id="home" className="relative flex flex-col overflow-hidden items-center justify-center w-full min-h-[70vh]">
      <div className="relative z-10 p-8 px-10 text-center section">
        <div 
          data-aos="fade-down"
          data-aos-delay="200"
          className="m-auto !my-20 w-fit h-fit"
        >
        ...
        <h1 
          data-aos="fade-up"
          data-aos-delay="400"
          className="text-4xl font-bold text-white normal-case md:text-5xl font-monospace"
        >
        ...
        <div 
          data-aos="fade-up"
          data-aos-delay="1000"
          className="flex items-center justify-center max-w-xs m-auto mt-24"
        >
