  ...
  if (isMobile) {
    return (
      <div key={project.id} className="w-full mb-20">
        <div 
          data-aos="fade-up"
          className="flex flex-wrap items-center w-full gap-12 lg:flex-nowrap bg-neutral-950 rounded-xl"
        >
          <div 
            data-aos="fade-right"
            data-aos-delay="200"
          ...
          <div 
            data-aos="fade-left"
            data-aos-delay="300"
            className="w-full space-y-8 lg:space-y-5 lg:flex-[5] p-10"
          >
            ...
            <div 
              data-aos="fade-up"
              data-aos-delay="400"
              className="flex items-center gap-8 !my-6"
            >
        ...
        {project.id % 2 === 0 ? (
          <>
            <div 
              data-aos="fade-right"
              data-aos-delay="200"
              className="w-full space-y-8 lg:space-y-5 lg:flex-[5]"
            >
              <h2 className="md:text-5xl text-4xl font-bold text-white normal-case font-monospace">{project.title}</h2>
              <p className="md:text-3xl text-[1.7rem] font-medium normal-case text-neutral-300">{project.overview}</p>
